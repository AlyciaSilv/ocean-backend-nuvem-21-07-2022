...
async function main() {
  ...
  app.get("/", function (req, res) {
    res.send("<h2>Escolhe uma fruta para comprar</h2><select><option>Escolha...</option><a href='/herois'><option>Banana</option></a><option>Maçã</option><option>Kiwi</option><option>Laranja</option></select>");
  });
